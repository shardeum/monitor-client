...
!(function (t, e) {
  ...
  const ui = (t) => 0 === t || 1 === t,
    ...
    pi = {
      ...
      easeInOutExpo: (t) =>
        ui(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
  ...
  class Ti {
    ...
    _dataCheck() {
      ...
      U(i)
        ...
        : t._data !== i &&
          (t._data && (le(t._data, t), Ci(t._cachedMeta)), i && Object.isExtensible(i) && re(i, t), (t._data = i))
    }
    addElements() {
      const t = this,
        e = t._cachedMeta
  ...
  class Yi extends Ri {
    ...
    fit() {
      ...
      if (a) {
        ...
        if (
          (r ? ((e.width = t.maxWidth), (e.height = Hi(s) + a)) : ((e.height = t.maxHeight), (e.width = Hi(s) + a)),
    ...
    drawGrid(t) {
      ...
      if (a) {
        ...
        let n, r, l, c
        e.isHorizontal()
          ? ((n = Ut(o, e.left, a) - a / 2), (r = Ut(o, e.right, t) + t / 2), (l = c = i))
          : ((l = Ut(o, e.top, a) - a / 2), (c = Ut(o, e.bottom, t) + t / 2), (n = r = i)),
      ...
      const {
        ...
        return (
          t.isHorizontal()
            ...
            : ((h = Bi(t, i, e)), (d = o(n, r, s)), (u = 'left' === i ? -wt : wt)),
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a && ((o.cp1x = hn(o.cp1x, e.left, e.right)), (o.cp1y = hn(o.cp1y, e.top, e.bottom))),
              r && ((o.cp2x = hn(o.cp2x, e.left, e.right)), (o.cp2y = hn(o.cp2y, e.top, e.bottom))))
      })(t, i)
  }
  function un(t, e, i, n) {
    ...
    for (let t = h, i = h; t <= d; ++t)
      (m = e[t % a]),
        m.skip ||
          ...
          null !== _ && v() && (g.push(_n({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
          (i = t),
          (x = p))
          ...
          for (const r of t) {
            ...
            for (a = s + 1; a <= r.end; a++) {
              ...
              ;(l = kn(i.setContext({ type: 'segment', p0: c, p1: h }))),
                Sn(l, t) && (o.push({ start: s, end: a - 1, loop: r.loop, style: t }), (t = l), (s = a - 1)),
                (c = h),
                (t = l)
            }
  ...
  function Xn(t) {
    return (
      Un() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class Gn {
    constructor(t, e) {
      ...
      ;(this.id = j()),
        ...
        (qn[n.id] = n),
        l && c
          ? (a.listen(n, 'complete', $n), a.listen(n, 'progress', Yn), n._initialize(), n.attached && n.update())
    ...
    _initializePlatform(t, e) {
      return e.platform
        ? new e.platform()
        : !Un() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
        ? new Ze()
        : new hi()
    }
    clear() {
    ...
    render() {
      ...
      !1 !== t.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), $n({ chart: t })))
    }
    draw() {
      const t = this
      let e
  ...
  Object.defineProperties(Gn, {
    defaults: { enumerable: Qn, value: mt },
    instances: { enumerable: Qn, value: qn },
    overrides: { enumerable: Qn, value: ut },
    registry: { enumerable: Qn, value: Cn },
    version: { enumerable: Qn, value: '3.1.0' },
    getChart: { enumerable: Qn, value: Kn },
    register: {
      enumerable: Qn,
      value: (...t) => {
        Cn.add(...t), Zn()
  ...
  class ao extends Ti {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let d, u, f, g
      for (d = i, u = i + n; d < u; ++d)
        (g = e[d]), (f = {}), (f[o.axis] = o.parse(lt(g, l), d)), h.push(no(lt(g, c), f, s, d))
      return h
    }
    updateRangeFromParsed(t, e, i, n) {
      ...
      let { start: r, count: l } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          d && (o = Nt(Math.min(ne(r, a.axis, c).lo, i ? n : ne(e, l, a.getPixelForValue(c)).lo), 0, n - 1)),
            (s = u
              ? Nt(Math.max(ne(r, a.axis, h).hi + 1, i ? 0 : ne(e, l, a.getPixelForValue(h)).hi + 1), o, n) - o
              : n - o)
        }
  ...
  ;(co.id = 'line'),
    ...
    (co.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } })
  class ho extends Ti {
    constructor(t, e) {
  ...
  class uo extends lo {}
  ;(uo.id = 'pie'), (uo.defaults = { cutout: 0, rotation: 0, circumference: 360, radius: '100%' })
  class fo extends Ti {
    getLabelAndValue(t) {
  ...
  ;(fo.id = 'radar'),
    ...
    (fo.overrides = { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } })
  class go extends co {}
  ;(go.id = 'scatter'),
    (go.defaults = { showLine: !1, fill: !1 }),
    (go.overrides = {
  ...
  ;(vo.id = 'arc'),
    ...
    (vo.defaultRoutes = { backgroundColor: 'backgroundColor' })
  const Co = 'function' == typeof Path2D
  function Oo(t, e, i, n) {
    Co && 1 === e.segments.length
      ? (function (t, e, i, n) {
          let o = e._path
      ...
      : (function (t, e, i, n) {
          const { segments: o, options: s } = e,
            a = Do(e)
          for (const r of o)
            wo(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke()
        })(t, e, i, n)
  }
  class Ao extends Ri {
    constructor(t) {
    ...
    draw(t, e, i, n) {
      ...
      ;(o.points || []).length &&
        s.borderWidth &&
        (t.save(), Oo(t, o, i, n), t.restore(), o.animated && ((o._pointsUpdated = !1), (o._path = void 0)))
    }
  }
  function To(t, e, i, n) {
    const o = t.options,
  ...
  function Eo(t) {
    ...
    const i = {}
    return e
      ? ((e = t.horizontal ? Io(e, 'left', 'right', t.base > t.x) : Io(e, 'bottom', 'top', t.base < t.y)),
        (i[e] = !0),
        i)
      : i
  }
      ...
      ? (function (t) {
          ...
          if (((h = 'start' === i ? a : 'end' === i ? r : U(i) ? i.value : e.getBaseValue()), n.grid.circular))
            return (
              ...
              new Uo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) })
            )
  ...
  function qo(t) {
    ...
    l.push(Qo({ x: null, y: i.bottom }, o))
    for (let t = 0; t < a.length; t++) {
      const e = a[t]
      for (let t = e.start; t <= e.end; t++) Go(s, r[t], l)
    }
    return new Ao({ points: s, options: {} })
  }
  ...
  function Qo(t, e) {
    ...
    return (
      ...
      i.length ? new Ao({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n }) : null
    )
  }
  function Jo(t, e, i) {
    let n = t[e].fill
          ...
          for (const e of r) {
            ...
            for (const t of l)
              a.push({
                source: t,
                target: e,
                start: { [i]: is(n, r, 'start', Math.max) },
                end: { [i]: is(n, r, 'end', Math.min) },
              })
          }
        }
        return a
      ...
      (function (t, e) {
        ...
        t.save(),
          'x' === l &&
            s !== o &&
            (ts(t, n, a.top),
            ss(t, { line: i, target: n, color: o, scale: r, property: l }),
            t.restore(),
            t.save(),
            ts(t, n, a.bottom)),
          ss(t, { line: i, target: n, color: s, scale: r, property: l }),
          t.restore()
      })(t, { line: o, target: n, above: c, below: h, area: i, scale: s }),
      Zt(t))
  }
  var rs = {
    id: 'filler',
        ...
        !(function (t, e, i) {
          ...
          if (
            ...
            const o = e + Math.max((g - b) / 2, 0),
              ...
              r = Ee(i.borderRadius)
            a.beginPath(),
              Object.values(r).some((t) => 0 !== t) ? ee(a, { x: s, y: o, w: x, h: b, radius: r }) : a.rect(s, o, x, b),
              a.fill(),
              0 !== n && a.stroke()
          }
          a.restore()
  ...
  var hs = {
    ...
    _element: cs,
    start(t, e, i) {
      const n = (t.legend = new cs({ ctx: t.ctx, options: i, chart: t }))
  ...
  var us = {
    ...
    start(t, e, i) {
      !(function (t, e) {
        const i = new ds({ ctx: t.ctx, options: e, chart: t })
  ...
  function _s(t, e, i) {
    ...
    return { xAlign: e.xAlign || bs(t, e, i, n), yAlign: n }
  }
  function ys(t, e, i, n) {
  ...
  var Ss = {
      ...
      positioners: fs,
      afterInit(t, e, i) {
        i && (t.tooltip = new ks({ _chart: t, options: i }))
      },
      beforeUpdate(t, e, i) {
  ...
  class Cs extends Yi {
    ...
    parse(t, e) {
      ...
      return ((t, e) =>
        null === t
          ? null
          : Nt(Math.round(t), 0, e))((e = isFinite(e) && i[e] === t ? e : Ds(i, t, K(e, t))), i.length - 1)
    }
    determineDataLimits() {
      const t = this,
  ...
  ;(Cs.id = 'category'), (Cs.defaults = { ticks: { callback: Cs.prototype.getLabelForValue } })
  class Os extends Yi {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        let v = 0
        for (
          f && (i.push({ value: o }), x <= o && v++, At(Math.round((x + v * y) * m) / m, o, y / 10) && v++);
          v < _;
          ++v
        )
  ...
  ;(As.id = 'linear'), (As.defaults = { ticks: { callback: Fi.formatters.numeric } })
  class Rs extends Yi {
    constructor(t) {
    ...
    buildTicks() {
      const t = this,
        ...
        i = (function (t, e) {
          ...
          do {
            o.push({ value: s, major: Ts(s) }),
              ++r,
              10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
              (s = Math.round(r * Math.pow(10, a) * l) / l)
          } while (a < i || (a === i && r < n))
          const c = q(t.max, s)
          return o.push({ value: c, major: Ts(s) }), o
  ...
  ;(Rs.id = 'logarithmic'), (Rs.defaults = { ticks: { callback: Fi.formatters.logarithmic, major: { enabled: !0 } } })
  class Bs extends Os {
    constructor(t) {
      super(t),
        (this.xCenter = void 0),
  ...
  ;(Bs.id = 'radialLinear'),
    ...
    (Bs.descriptors = { angleLines: { _fallback: 'grid' } })
  const Ws = {
  ...
  function js(t, e) {
    ...
    return (
      ...
      null === r
        ? null
        : (s && (r = 'week' !== s || (!Ot(a) && !0 !== a) ? i.startOf(r, s) : i.startOf(r, 'isoWeek', a)), +r)
    )
  }
  function $s(t, e, i, n) {
    const o = Ns.length
  ...
  class Xs extends Yi {
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? $s(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
        ...
        (t._majorUnit =
          n.major.enabled && 'year' !== t._unit
            ? (function (t) {
                for (let e = Ns.indexOf(t) + 1, i = Ns.length; e < i; ++e) if (Ws[Ns[e]].common) return Ns[e]
              })(t._unit)
            : void 0),
        t.initOffsets(o),
        e.reverse && a.reverse(),
    ...
    _generate() {
      ...
      return (
        (d !== n && 'ticks' !== o.bounds && 1 !== u) || Ys(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      )
  ...
  return (
    Gn.register(po, Gs, Ho, Ps),
    (Gn.helpers = { ...Pn }),
    (Gn._adapters = eo),
    (Gn.Animation = bi),
    (Gn.Animations = yi),
    (Gn.animator = a),
    (Gn.controllers = Cn.controllers.items),
    (Gn.DatasetController = Ti),
    (Gn.Element = Ri),
    (Gn.elements = Ho),
    (Gn.Interaction = Ce),
    (Gn.layouts = Ke),
    ...
    (Gn.Scale = Yi),
    (Gn.Ticks = Fi),
    Object.assign(Gn, po, Gs, Ho, Ps, di),
    (Gn.Chart = Gn),
