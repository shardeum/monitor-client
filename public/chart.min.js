...
!(function (t, e) {
    ...
    const ui = (t) => 0 === t || 1 === t,
        ...
        pi = {
            ...
            easeInOutBounce: (t) =>
                t < 0.5 ? 0.5 * pi.easeInBounce(2 * t) : 0.5 * pi.easeOutBounce(2 * t - 1) + 0.5,
        },
        mi = 'transparent',
        xi = {
        ...
        for (let t = h, i = h; t <= d; ++t)
            (m = e[t % a]),
                m.skip ||
                    ...
                    null !== _ &&
                        v() &&
                        (g.push(_n({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
                    (i = t),
                    (x = p))
        ...
        return i && i.setContext && e
            ? (function (t, e, i) {
                  ...
                  for (const r of t) {
                      ...
                      s < a - 1 &&
                          (o.push({ start: s, end: a - 1, loop: r.loop, style: l }), (s = a - 1))
                  }
                  return o
              })(t, e, i)
            : t
    ...
    class On {
        ...
        notify(t, e, i, n) {
            ...
            const s = n ? o._descriptors(t).filter(n) : o._descriptors(t),
                a = o._notify(s, t, e, i)
            return (
                'destroy' === e && (o._notify(s, t, 'stop'), o._notify(o._init, t, 'uninstall')), a
            )
        }
        _notify(t, e, i, n) {
            n = n || {}
    ...
    class Gn {
        constructor(t, e) {
            ...
            ;(this.id = j()),
                ...
                (qn[n.id] = n),
                l && c
                    ? (a.listen(n, 'complete', $n),
                      a.listen(n, 'progress', Yn),
                      n._initialize(),
                      n.attached && n.update())
                    : console.error(
            ...
            i &&
                ...
                J(s, (i) => {
                    const s = i.options,
                        ...
                        r = Ln(a, s),
                        l = K(s.type, i.dtype)
                    ;(void 0 !== s.position && Hn(s.position, r) === Hn(i.dposition)) ||
                        (s.position = i.dposition),
                        (o[a] = !0)
                    let c = null
                    if (a in n && n[a].type === l) c = n[a]
                    else {
                        ;(c = new (Cn.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t })),
                            (n[c.id] = c)
                    }
                    c.init(s, e)
                }),
    ...
    function oo(t, e, i, n) {
        ...
        let c, h, d, u
        for (c = i, h = i + n; c < h; ++c)
            (u = e[c]), (d = {}), (d[o.axis] = r || o.parse(a[c], c)), l.push(no(u, d, s, c))
        return l
    }
    function so(t) {
        ...
        update(t) {
            ...
            ;(e._drawStart = r),
                ...
                (function (t) {
                    ...
                    const s =
                        n.xmin !== e.min || n.xmax !== e.max || n.ymin !== i.min || n.ymax !== i.max
    ...
    function Eo(t) {
        ...
        return e
            ? ((e = t.horizontal
                  ? Io(e, 'left', 'right', t.base > t.x)
                  : Io(e, 'bottom', 'top', t.base < t.y)),
              (i[e] = !0),
              i)
            : i
    }
    function Io(t, e, i, n) {
        ...
        return (
            n
                ? ((a = i), (t = Fo((t = (o = t) === (s = e) ? a : o === a ? s : o), i, e)))
                : (t = Fo(t, e, i)),
            t
        )
    }
    ...
    function Xo(t) {
        return (t.scale || {}).getPointPositionForValue
            ? (function (t) {
                  ...
                  if (
                      ((h =
                          'start' === i ? a : 'end' === i ? r : U(i) ? i.value : e.getBaseValue()),
                      n.grid.circular)
                  )
                      return (
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < n; ++a)
                (s = t.getDatasetMeta(a)),
                    ...
                    o.push(l)
            for (a = 0; a < n; ++a)
                (l = o[a]), l && !1 !== l.fill && (l.fill = Jo(o, a, i.propagate))
        },
        beforeDatasetsDraw(t, e, i) {
            ...
            for (let e = n.length - 1; e >= 0; --e) {
                ...
                s &&
                    ...
                    'beforeDatasetsDraw' === i.drawTime && as(t.ctx, s, o))
            }
        },
    ...
    function Ds(t, e, i) {
        const n = t.indexOf(e)
        if (-1 === n)
            return ((t, e, i) => ('string' == typeof e ? t.push(e) - 1 : isNaN(e) ? null : i))(
                t,
                e,
                i
            )
    ...
    class Cs extends Yi {
        ...
        parse(t, e) {
            ...
            return ((t, e) => (null === t ? null : Nt(Math.round(t), 0, e)))(
                (e = isFinite(e) && i[e] === t ? e : Ds(i, t, K(e, t))),
                i.length - 1
            )
        }
        determineDataLimits() {
    ...
    class Os extends Yi {
        ...
        parse(t, e) {
            return $(t) || (('number' == typeof t || t instanceof Number) && !isFinite(+t))
                ? null
                : +t
        }
                ...
                ;(_ = Math.ceil(u / y) - Math.floor(d / y)),
                    ...
                    f && g && n && Tt((s - o) / n, y / 1e3)
                        ...
                        : p
                          ...
                          : ((_ = (b - x) / y),
                            (_ = At(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_))),
    ...
    ;(Rs.id = 'logarithmic'),
        (Rs.defaults = { ticks: { callback: Fi.formatters.logarithmic, major: { enabled: !0 } } })
    class Bs extends Os {
        constructor(t) {
            super(t),
                (this.xCenter = void 0),
