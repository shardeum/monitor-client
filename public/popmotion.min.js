!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['exports'], e)
    : e(((t = 'undefined' != typeof globalThis ? globalThis : t || self).popmotion = {}))
})(this, function (t) {
  'use strict'
  function e(t, e) {
    var n = {}
  ...
  function u(t) {
    ...
    function x() {
      const t = y ? -y / 1e3 : 0,
        ...
        o = h / (2 * Math.sqrt(d * g)),
        a = Math.sqrt(d / g) / 1e3
      if ((null != p || (p = Math.abs(r - n) <= 1 ? 0.01 : 0.4), o < 1)) {
        const n = s(a, o)
        ;(v = (s) => {
          ...
          (O = (r) => {
            ...
            return (
              o * a * s * ((Math.sin(n * r) * (t + o * a * e)) / n + e * Math.cos(n * r)) -
              s * (Math.cos(n * r) * (t + o * a * e) - n * e * Math.sin(n * r))
            )
          })
  ...
  const l = (t) => 0,
    ...
    f = (t, e, n) => -n * t + n * e + t,
    m = (t, e) => (n) => Math.max(Math.min(n, e), t),
    d = (t) => (t % 1 ? Number(t.toFixed(5)) : t),
    h = /(-)?([\d]*\.?[\d])+/g,
  ...
  const M = { test: (t) => 'number' == typeof t, parse: parseFloat, transform: (t) => t },
    v = Object.assign(Object.assign({}, M), { transform: m(0, 1) })
  ...
  const w = (t, e) => (n) =>
      Boolean((b(n) && y.test(n) && n.startsWith(t)) || (e && Object.prototype.hasOwnProperty.call(n, e))),
    j = (t, e, n) => (r) => {
      if (!b(r)) return r
      const [o, s, a, i] = r.match(h)
      return {
        [t]: parseFloat(o),
        [e]: parseFloat(s),
        [n]: parseFloat(a),
    ...
    I = {
      ...
      transform: ({ hue: t, saturation: e, lightness: n, alpha: r = 1 }) =>
        'hsla(' + Math.round(t) + ', ' + O.transform(d(e)) + ', ' + O.transform(d(n)) + ', ' + d(v.transform(r)) + ')',
    },
    A = m(0, 255),
    ...
    P = {
      ...
      transform: ({ red: t, green: e, blue: n, alpha: r = 1 }) =>
        'rgba(' + D.transform(t) + ', ' + D.transform(e) + ', ' + D.transform(n) + ', ' + d(v.transform(r)) + ')',
    }
  const S = {
      test: w('#'),
      parse: function (t) {
  ...
  function q(t) {
    ...
    const o = t.match(h)
    return o && ((t = t.replace(h, k)), e.push(...o.map(M.parse))), { values: e, numColors: n, tokenised: t }
  }
  function N(t) {
    return q(t).values
  }
  function $(t) {
    ...
    return (t) => {
      let e = r
      for (let r = 0; r < o; r++) e = e.replace(r < n ? C : k, r < n ? R(t[r]) : d(t[r]))
      return e
    }
  }
  ...
  const E = {
      test: function (t) {
        ...
        return (
          isNaN(t) &&
          b(t) &&
          (null !== (n = null === (e = t.match(h)) || void 0 === e ? void 0 : e.length) && void 0 !== n ? n : 0) +
            (null !== (o = null === (r = t.match(g)) || void 0 === r ? void 0 : r.length) && void 0 !== o ? o : 0) >
            0
        )
      },
      parse: N,
    ...
    z = [S, P, I],
    G = (t) => z.find((e) => e.test(t)),
    H = (t, e) => {
      const n = G(t),
        r = G(e)
      if ((n.transform, r.transform, !n || !r || n.transform !== r.transform)) return (n) => `${n > 0 ? e : t}`
      const o = n.parse(t),
        s = r.parse(e),
        a = Object.assign({}, o),
        i = n === I ? f : U
      return (t) => {
        for (const e in a) 'alpha' !== e && (a[e] = i(o[e], s[e], t))
    ...
    V = (...t) => t.reduce(_)
  function J(t, e) {
    return W(t) ? (n) => f(t, e, n) : T(t) ? H(t, e) : Y(t, e)
  }
  const K = (t, e) => {
      const n = [...t],
        r = n.length,
    ...
    Q = (t, e) => {
      const n = Object.assign(Object.assign({}, t), e),
        r = {}
      for (const o in n) void 0 !== t[o] && void 0 !== e[o] && (r[o] = J(t[o], e[o]))
      return (t) => {
  ...
  function et(t, e, { clamp: r = !0, ease: o, mixer: s } = {}) {
    const a = t.length
    e.length,
  ...
  const nt = (t) => (e) => 1 - t(1 - e),
    rt = (t) => (e) => e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
    ot = (t) => (e) => Math.pow(e, t),
    st = (t) => (e) => e * e * ((t + 1) * e - t),
    at = (t) => {
      const e = st(t)
    ...
    Mt = nt(bt)
  function vt(t, e) {
    return t.map(() => e || lt).splice(0, t.length - 1)
  }
  function Ot({ from: t = 0, to: e = 1, ease: n, offset: r, duration: o = 300 }) {
    ...
    function c() {
      return et(i, a, { ease: Array.isArray(n) ? n : vt(a, n) })
    }
    let u = c()
    return {
  ...
  const wt = { keyframes: Ot, spring: u, decay: xt }
  const jt = (1 / 60) * 1e3,
    It = 'undefined' != typeof performance ? () => performance.now() : () => Date.now(),
    At = 'undefined' != typeof window ? (t) => window.requestAnimationFrame(t) : (t) => setTimeout(() => t(It()), jt)
  let Dt = !0,
    Pt = !1,
    St = !1
  const Tt = { delta: 0, timestamp: 0 },
    Ft = ['read', 'update', 'preRender', 'render', 'postRender'],
    Rt = Ft.reduce(
      (t, e) => (
        (t[e] = (function (t) {
          let e = [],
          ...
          const s = new WeakSet(),
            a = {
              schedule: (t, a = !1, i = !1) => {
                const c = i && o,
                  u = c ? e : n
                return a && s.add(t), -1 === u.indexOf(t) && (u.push(t), c && o && (r = e.length)), t
              },
              cancel: (t) => {
                const e = n.indexOf(t)
    ...
    Ct = Ft.reduce((t, e) => {
      const n = Rt[e]
      return (t[e] = (t, e = !1, r = !1) => (Pt || $t(), n.schedule(t, e, r))), t
    }, {}),
    kt = Ft.reduce((t, e) => ((t[e] = Rt[e].cancel), t), {})
  Ft.reduce((t, e) => ((t[e] = () => Rt[e].process(Tt)), t), {})
  const qt = (t) => Rt[t].process(Tt),
    Nt = (t) => {
      ;(Pt = !1),
        (Tt.delta = Dt ? jt : Math.max(Math.min(t - Tt.timestamp, 40), 1)),
        (Tt.timestamp = t),
        (St = !0),
        Ft.forEach(qt),
        (St = !1),
  ...
  const Ut = (t) => {
    const e = ({ delta: e }) => t(e)
    return { start: () => Ct.update(e, !0), stop: () => kt.update(e) }
  }
  function zt(t) {
    var n,
      r,
    ...
    let b,
      ...
      I = !0
    const A = (function (t) {
      if (Array.isArray(t.to)) return Ot
      if (wt[t.type]) return wt[t.type]
    ...
    ;(null === (r = (n = A).needsInterpolation) || void 0 === r ? void 0 : r.call(n, o, O)) &&
      ((v = et([0, 100], [o, O], { clamp: !1 })), (o = 0), (O = 100))
    ...
    function P() {
      x++,
        'reverse' === l
          ...
          : ((i = Et(i, w, p)), 'mirror' === l && D.flipTarget()),
        (j = !1),
        h && h()
    }
    function S(t) {
  ...
  const Ht = (t) => (180 * t) / Math.PI,
    ...
    Vt = Wt(Math.sqrt),
    Jt = (t) => (t * Math.PI) / 180,
    Kt = (t) => t.hasOwnProperty('x') && t.hasOwnProperty('y'),
    Qt = (t) => Kt(t) && t.hasOwnProperty('z'),
    Xt = (t, e) => Math.abs(t - e)
  const Yt = (t, e = 2) => ((e = Math.pow(10, e)), Math.round(t * e) / e),
    Zt = (t, e, n, r = 0) => Yt(t + (n * (e - t)) / Math.max(r, n))
  const te = (t, e) => 1 - 3 * e + 3 * t,
    ee = (t, e) => 3 * e - 6 * t,
    ne = (t) => 3 * t,
    re = (t, e, n) => ((te(e, n) * t + ee(e, n)) * t + ne(e)) * t,
    oe = (t, e, n) => 3 * te(e, n) * t * t + 2 * ee(e, n) * t + ne(e)
  const se = 0.1
  ;(t.angle = (t, e = L) => Ht(Math.atan2(e.y - t.y, e.x - t.x))),
    (t.animate = zt),
    (t.anticipate = yt),
    (t.applyOffset = (t, e) => {
      let n = !0
    ...
    (t.backOut = ht),
    (t.bounceIn = Mt),
    (t.bounceInOut = (t) => (t < 0.5 ? 0.5 * (1 - bt(1 - 2 * t)) : 0.5 * bt(2 * t - 1) + 0.5)),
    (t.bounceOut = bt),
    (t.circIn = pt),
    (t.circInOut = mt),
    (t.circOut = ft),
    (t.clamp = n),
    (t.createAnticipate = at),
    (t.createAttractor = Wt),
    (t.createBackIn = st),
    (t.createExpoIn = ot),
    (t.cubicBezier = function (t, e, n, r) {
      if (t === e && n === r) return it
      const o = new Float32Array(11)
      for (let e = 0; e < 11; ++e) o[e] = re(e * se, t, n)
      function s(e) {
        let r = 0,
          s = 1
        for (; 10 !== s && o[s] <= e; ++s) r += se
        --s
        const a = r + ((e - o[s]) / (o[s + 1] - o[s])) * se,
          i = oe(a, t, n)
        return i >= 0.001
          ? (function (t, e, n, r) {
              for (let o = 0; o < 8; ++o) {
          ...
          : (function (t, e, n, r, o) {
              let s,
                ...
                i = 0
              do {
                ;(a = e + (n - e) / 2), (s = re(a, r, o) - t), s > 0 ? (n = a) : (e = a)
              } while (Math.abs(s) > 1e-7 && ++i < 10)
              return a
            })(e, r, r + se, t, n)
      }
      return (t) => (0 === t || 1 === t ? t : re(s(t), e, r))
    }),
    (t.decay = xt),
    (t.degreesToRadians = Jt),
    (t.distance = function (t, e) {
      if (W(t) && W(e)) return Xt(t, e)
      if (Kt(t) && Kt(e)) {
        const n = Xt(t.x, e.x),
          r = Xt(t.y, e.y),
          o = Qt(t) && Qt(e) ? Xt(t.z, e.z) : 0
    ...
    (t.inertia = function ({
      ...
      if (h(t)) b({ from: t, velocity: e, to: g(t) })
      else {
        let r = o * e + t
        void 0 !== u && (r = u(r))
        const a = g(r),
        ...
        const f = (t) => {
          ;(l = p),
            (p = t),
            (e = Gt(t - l, Bt().delta)),
            ((1 === i && t > a) || (-1 === i && t < a)) && b({ from: t, to: a, velocity: e })
        }
        y({
          type: 'decay',
          from: t,
      ...
      return { stop: () => (null == d ? void 0 : d.stop()) }
    }),
    (t.interpolate = et),
    (t.isPoint = Kt),
    (t.isPoint3D = Qt),
    ...
    (t.mixComplex = Y),
    (t.pipe = V),
    (t.pointFromVector = (t, e, n) => ((e = Jt(e)), { x: n * Math.cos(e) + t.x, y: n * Math.sin(e) + t.y })),
    (t.progress = p),
    (t.radiansToDegrees = Ht),
    (t.reverseEasing = nt),
    (t.smooth = (t = 50) => {
      let e = 0,
        n = 0
      return (r) => {
        const o = Bt().timestamp,
          s = o !== n ? o - n : 0,
          a = s ? Zt(e, r, s, t) : e
        return (n = o), (e = a), a
      }
