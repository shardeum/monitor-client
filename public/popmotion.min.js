!(function (t, e) {
    ...
    function o({ duration: t = 800, bounce: e = 0.25, velocity: o = 0, mass: a = 1 }) {
        ...
        ;(u = n(0.05, 1, u)),
            ...
            u < 1
                ...
                : ((i = (e) => Math.exp(-e * t) * ((e - o) * t + 1) - 0.001),
                  (c = (e) => Math.exp(-e * t) * (t * t * (o - e))))
                    ...
                    (O = (r) => {
                        ...
                        return (
                            o *
                                a *
                                s *
                                ((Math.sin(n * r) * (t + o * a * e)) / n + e * Math.cos(n * r)) -
    ...
    function q(t) {
        ...
        const o = t.match(h)
        return (
            o && ((t = t.replace(h, k)), e.push(...o.map(M.parse))),
    ...
    const E = {
            test: function (t) {
                ...
                return (
                    isNaN(t) &&
                    b(t) &&
                    (null !== (n = null === (e = t.match(h)) || void 0 === e ? void 0 : e.length) &&
                    void 0 !== n
                        ? n
                        : 0) +
                        (null !==
                            (o = null === (r = t.match(g)) || void 0 === r ? void 0 : r.length) &&
                        void 0 !== o
                            ? o
                            : 0) >
                        0
        ...
        H = (t, e) => {
            const n = G(t),
                r = G(e)
            if ((n.transform, r.transform, !n || !r || n.transform !== r.transform))
                return (n) => `${n > 0 ? e : t}`
            const o = n.parse(t),
                s = r.parse(e),
                a = Object.assign({}, o),
                    ...
                    const s = new WeakSet(),
                        a = {
                            schedule: (t, a = !1, i = !1) => {
                                ...
                                return (
                                    a && s.add(t),
                                    -1 === u.indexOf(t) && (u.push(t), c && o && (r = e.length)),
                                    t
                                )
                            },
                            cancel: (t) => {
    ...
    ;(t.angle = (t, e = L) => Ht(Math.atan2(e.y - t.y, e.x - t.x))),
        ...
        (t.applyOffset = (t, e) => {
            let n = !0
            return (
                void 0 === e && ((e = t), (n = !1)), (r) => (n ? r - t + e : ((t = r), (n = !0), e))
            )
        }),
        (t.attract = _t),
        (t.attractExpo = Vt),
        ...
        (t.mixComplex = Y),
        (t.pipe = V),
        (t.pointFromVector = (t, e, n) => (
            (e = Jt(e)), { x: n * Math.cos(e) + t.x, y: n * Math.sin(e) + t.y }
        )),
        (t.progress = p),
